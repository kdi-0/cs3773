...
const CreateDiscountCode = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h1 className="text-3xl mb-6 text-center font-bold">Create Discount Code</h1>
      <form onSubmit={createDiscount} className="space-y-6">
        <div className="">
          <label htmlFor="code" className="block mb-2 font-medium">Discount Code:</label>
          <input
            type="text"
            name="code"
        ...
        <div className="py-3">
          <label htmlFor="value" className="block mb-2 font-medium">Value:</label>
          <input
            type="number"
            name="value"
